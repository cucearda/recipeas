...
class Database:
    def __init__(self):
        self.dbname = "d947mekkhcn8bj"
        self.user = "kprnxybxdytkuu"
        self.host = "ec2-18-208-49-190.compute-1.amazonaws.com"
        self.password = "f56741243007919d8d588187efb46cd474dfdc9502050a79b62efe23376284d3"

    def add_user(self, username, hashed, nickname, karma, date, is_admin):
        with psycopg2.connect(dbname= self.dbname, user=self.user, host=self.host, password= self.password) as conn:
            cur = conn.cursor()
